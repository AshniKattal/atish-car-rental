...
export default function ServiceReportTemplatePdf({
  companyDetails,
  surveyDetail,
  ...
  const routineCheckboxList = defaultCheckBoxOptions?.routineCheckboxList;
      ...
      <Page size="A4" style={styles.page} wrap={false}>
        ...
        <View style={[styles.gridContainer, styles.mt8]}>
          <View style={styles.col8}>
            ...
            <Text style={{ fontSize: "10px", paddingBottom: "2px" }}>
              <span style={styles.body3Bold}>Services carries at: </span>
              {surveyDetail?.serviceCarriesAt || ""}
            </Text>
          </View>
          ...
          <View style={styles.col4}>
            ...
            <Text style={{ fontSize: "10px", paddingBottom: "2px" }}>
              <span style={styles.body3Bold}>Time In: </span>
              {surveyDetail?.timeIn || ""}
            </Text>

            <Text style={{ fontSize: "10px", paddingBottom: "2px" }}>
              <span style={styles.body3Bold}>Time Out: </span>
              {surveyDetail?.timeOut || ""}
            </Text>
        ...
        <View style={[styles.gridContainer, styles.mt8, styles.mb8]}>
          <Text style={styles.h5}>Routine:</Text>
        </View>

        <View style={[styles.gridContainer, styles.mb4]}>
          {routineCheckboxList &&
            routineCheckboxList?.length > 0 &&
            routineCheckboxList?.map((control, index) => (
              <View style={styles.col16Custom} key={index}>
                ...
                >
                  {surveyDetail?.routine &&
                  surveyDetail?.routine[control?.name] === true ? (
                    <Image
        ...
        <View style={[styles.mt8, styles.mb8]}>
          <Text style={{ fontSize: "10px" }}>
            <span style={styles.body3Bold}>FINDINGS: </span>
            {surveyDetail?.findings || ""}
          </Text>
        </View>
